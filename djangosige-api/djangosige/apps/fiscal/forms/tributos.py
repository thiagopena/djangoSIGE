    ...
    class Meta:
        ...
        widgets = {
            "descricao": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "title": "Insira uma breve descrição do grupo fiscal, EX: ICMS (Simples Nacional) + IPI",
                }
            ),
...
class ICMSForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "p_red_bc": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
            "mod_bcst": forms.Select(attrs={"class": "form-control"}),
            "p_mvast": forms.TextInput(attrs={"class": "form-control percentual-mask"}),
            "p_red_bcst": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
            "p_icmsst": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
...
class ICMSSNForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            ...
            "p_red_bcst",
            "p_icmsst",
            "icmssn_incluido_preco",
            "icmssnst_incluido_preco",
        )
        widgets = {
            "csosn": forms.Select(attrs={"class": "form-control"}),
            "p_cred_sn": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
            "mod_bc": forms.Select(attrs={"class": "form-control"}),
            "p_icms": forms.TextInput(attrs={"class": "form-control percentual-mask"}),
            ...
            "icmssn_incluido_preco": forms.CheckboxInput(
                attrs={"class": "form-control"}
            ),
            "icmssnst_incluido_preco": forms.CheckboxInput(
                attrs={"class": "form-control"}
            ),
        }
        labels = {
...
class ICMSUFDestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "p_fcp_dest": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
            "p_icms_dest": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
...
class COFINSForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "cst": forms.Select(attrs={"class": "form-control"}),
            "p_cofins": forms.TextInput(
                attrs={"class": "form-control percentual-mask"}
            ),
            "valiq_cofins": forms.TextInput(
