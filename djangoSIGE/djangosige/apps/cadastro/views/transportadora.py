...
class AdicionarTransportadoraView(AdicionarPessoaView):
    ...
    success_message = (
        "Transportadora <b>%(nome_razao_social)s</b>adicionada com sucesso."
    )
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super().get(request, form, veiculo_form=veiculo_form, *args, **kwargs)
    ...
    def post(self, request, *args, **kwargs):
        ...
        return super().post(request, form, veiculo_form=veiculo_form, *args, **kwargs)
