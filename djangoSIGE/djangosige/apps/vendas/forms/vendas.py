...
class VendaForm(forms.ModelForm):
    total_sem_imposto = forms.DecimalField(
        widget=forms.TextInput(
            attrs={"class": "form-control decimal-mask", "readonly": True}
        ),
        label="Total s/ imposto (R$)",
        required=False,
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "desconto": forms.TextInput(
                attrs={"class": "form-control decimal-mask-four"}
            ),
...
class ItensVendaForm(forms.ModelForm):
    total_sem_desconto = forms.DecimalField(
        widget=forms.TextInput(
            attrs={"class": "form-control decimal-mask", "readonly": True}
        ),
        label="Subtotal s/ desconto",
        required=False,
    )
    total_impostos = forms.DecimalField(
        widget=forms.TextInput(
            attrs={"class": "form-control decimal-mask", "readonly": True}
        ),
        label="Impostos",
    ...
    total_com_impostos = forms.DecimalField(
        widget=forms.TextInput(
            attrs={"class": "form-control decimal-mask", "readonly": True}
        ),
        label="Total",
    ...
    calculo_imposto = forms.CharField(
        widget=forms.TextInput(attrs={"class": "hidden", "disabled": True}),
        label="Cálc. Impostos",
        required=False,
    )
    ...
    p_red_bc = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    p_red_bcst = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    p_mvast = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    pfcp = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    p_icms_dest = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    p_icms_inter = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    p_icms_part = forms.DecimalField(
        widget=forms.TextInput(attrs={"class": "modal-field", "disabled": True}),
        required=False,
    )
    tipo_ipi = forms.ChoiceField(
        widget=forms.Select(attrs={"class": "modal-field", "disabled": True}),
        choices=(
            [
                ("1", "1"),
                ("2", "2"),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "valor_rateio_frete": forms.TextInput(
                attrs={"class": "form-control decimal-mask"}
            ),
            "valor_rateio_despesas": forms.TextInput(
                attrs={"class": "form-control decimal-mask"}
            ),
            "valor_rateio_seguro": forms.TextInput(
                attrs={"class": "form-control decimal-mask"}
            ),
