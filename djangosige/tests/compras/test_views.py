...
from djangosige.compras.models import ItensCompra, OrcamentoCompra, PedidoCompra
...
class ComprasListarViewsTestCase(BaseTestCase):
    def test_list_orcamento_compra_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listaorcamentocompraview"), deleted_object=obj
        )
    ...
    def test_list_orcamento_compra_vencido_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listaorcamentocompravencidosview"), deleted_object=obj
        )
    ...
    def test_list_orcamento_compra_vence_hoje_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listaorcamentocomprahojeview"), deleted_object=obj
        )
    ...
    def test_list_pedido_compra_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listapedidocompraview"), deleted_object=obj
        )
    ...
    def test_list_pedido_compra_atrasado_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listapedidocompraatrasadosview"), deleted_object=obj
        )
    ...
    def test_list_pedido_compra_entrega_hoje_view_deletar_objeto(self):
        ...
        self.check_list_view_delete(
            url=reverse("compras:listapedidocomprahojeview"), deleted_object=obj
        )
...
class ComprasEditarViewsTestCase(BaseTestCase):
    def test_edit_orcamento_compra_get_post_request(self):
        ...
        url = reverse("compras:editarorcamentocompraview", kwargs={"pk": obj.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_pedido_compra_get_post_request(self):
        ...
        url = reverse("compras:editarpedidocompraview", kwargs={"pk": obj.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        data = response.context["form"].initial
        data.update(COMPRA_FORMSET_DATA)
...
class VendasAjaxRequestViewsTestCase(BaseTestCase):
    def test_info_compra_post_request(self):
        ...
        self.check_json_response(url, data, obj_pk, model="compras.pedidocompra")
...
class ComprasAcoesUsuarioViewsTestCase(BaseTestCase):
    def test_gerar_pdf_orcamento_compra(self):
        # Buscar objeto qualquer
        obj = OrcamentoCompra.objects.order_by("pk").last()
        url = reverse("compras:gerarpdforcamentocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
    ...
    def test_gerar_pdf_pedido_compra(self):
        # Buscar objeto qualquer
        obj = PedidoCompra.objects.order_by("pk").last()
        url = reverse("compras:gerarpdfpedidocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.get("Content-Type"), "application/pdf")
    ...
    def test_gerar_pedido_compra(self):
        ...
        fornecedor = Fornecedor.objects.order_by("id").last()
        obj = OrcamentoCompra.objects.create(fornecedor=fornecedor)
        url = reverse("compras:gerarpedidocompra", kwargs={"pk": obj.pk})
    ...
    def test_copiar_pedido_compra(self):
        # Buscar objeto qualquer
        obj = PedidoCompra.objects.order_by("pk").last()
        url = reverse("compras:copiarpedidocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compras/pedido_compra/pedido_compra_edit.html"
    ...
    def test_copiar_orcamento_compra(self):
        # Buscar objeto qualquer
        obj = OrcamentoCompra.objects.order_by("pk").last()
        url = reverse("compras:copiarorcamentocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compras/orcamento_compra/orcamento_compra_edit.html"
        )
        self.assertTrue(isinstance(response.context["object"], OrcamentoCompra))

    def test_cancelar_pedido_compra(self):
        # Buscar objeto qualquer
        obj = PedidoCompra.objects.order_by("pk").last()
        url = reverse("compras:cancelarpedidocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compras/pedido_compra/pedido_compra_edit.html"
        ...
        self.assertTrue(isinstance(response.context["object"], PedidoCompra))
        self.assertEqual(response.context["object"].get_status_display(), "Cancelado")

    def test_cancelar_orcamento_compra(self):
        # Buscar objeto qualquer
        obj = OrcamentoCompra.objects.order_by("pk").last()
        url = reverse("compras:cancelarorcamentocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "compras/orcamento_compra/orcamento_compra_edit.html"
    ...
    def test_receber_pedido_compra(self):
        ...
        obj.save()
        prod1 = Produto(
            codigo="000000000000111",
            descricao="Produto Teste Recebimento Pedido Compra 1",
            controlar_estoque=True,
            estoque_atual="0.00",
        )
        prod1.save()
        prod2 = Produto(
            codigo="000000000000222",
            descricao="Produto Teste Recebimento Pedido Compra 2",
            controlar_estoque=True,
            estoque_atual="0.00",
        )
        prod2.save()
        item1 = ItensCompra(
            produto=prod1, quantidade=3, valor_unit="10.00", subtotal="30.00"
        )
        item1.compra_id = obj
        item1.save()
        item2 = ItensCompra(
            produto=prod2, quantidade=2, valor_unit="20.00", subtotal="40.00"
        )
        item2.compra_id = obj
        item2.save()
        url = reverse("compras:receberpedidocompra", kwargs={"pk": obj.pk})
        response = self.client.get(url, follow=True)
        self.assertEqual(response.status_code, 200)
