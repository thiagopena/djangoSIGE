...
class InfoVenda(View):
    def post(self, request, *args, **kwargs):
        ...
        for item in itens_venda:
            ...
            itens_editable_fields_dict[
                "editable_field_vq_bcpis"
            ] = item.format_valor_attr("vq_bcpis")
            itens_editable_fields_dict[
                "editable_field_vq_bccofins"
            ] = item.format_valor_attr("vq_bccofins")
            itens_editable_fields_dict["editable_field_vpis"] = item.format_valor_attr(
                "vpis"
            )
            itens_editable_fields_dict[
                "editable_field_vcofins"
            ] = item.format_valor_attr("vcofins")
            itens_editable_fields_dict[
                "editable_field_vicms_deson"
            ] = item.format_valor_attr("vicms_deson")
