...
class AdicionarProdutoView(CustomCreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if (
                self.object.controlar_estoque
                and form.cleaned_data["estoque_inicial"] > 0
            ):
...
class EditarOutrosBaseView(CustomUpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super(EditarOutrosBaseView, self).get_context_data(**kwargs)
