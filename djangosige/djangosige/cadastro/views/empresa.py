...
from djangosige.cadastro.forms import EmpresaForm
...
class AdicionarEmpresaView(AdicionarPessoaView):
    ...
    def post(self, request, *args, **kwargs):
        form = EmpresaForm(
            request.POST, request.FILES, prefix="empresa_form", request=request
        )
...
class EditarEmpresaView(EditarPessoaView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(EditarEmpresaView, self).get(
            request, form, logo_file=logo_file, *args, **kwargs
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        logo_file = Empresa.objects.get(pk=self.object.pk).logo_file
        return super(EditarEmpresaView, self).post(
            request, form, logo_file=logo_file, *args, **kwargs
        )
