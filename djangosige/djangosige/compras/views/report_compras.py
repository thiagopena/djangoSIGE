...
class DadosFornecedor(ReportBand):
    def __init__(self):
        ...
        self.elements = []
        txt = ObjectValue(
            attribute_name="fornecedor.nome_razao_social",
            top=0.3 * cm,
            left=0.3 * cm,
            width=8 * cm,
            height=0.5 * cm,
    ...
    def inserir_informacoes_pj(self):
        txt = ObjectValue(
            attribute_name="fornecedor.pessoa_jur_info.format_cnpj",
            top=0.3 * cm,
            left=8.1 * cm,
            width=4 * cm,
            height=0.5 * cm,
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.pessoa_jur_info.format_ie",
            top=0.3 * cm,
            left=13 * cm,
            width=6.4 * cm,
            height=0.5 * cm,
    ...
    def inserir_informacoes_endereco(self):
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.endereco_padrao.format_endereco",
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.endereco_padrao.municipio",
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.endereco_padrao.uf",
            display_format="UF: %s",
            top=1.6 * cm,
            left=8.1 * cm,
            width=4 * cm,
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.endereco_padrao.cep",
    ...
    def inserir_informacoes_telefone(self):
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.telefone_padrao.telefone",
    ...
    def inserir_informacoes_email(self):
        ...
        txt = ObjectValue(
            attribute_name="fornecedor.email_padrao.email",
...
class DadosProdutosCompra(DadosProdutos):
    def __init__(self):
        ...
        self.get_queryset = (
            lambda self, parent_object: ItensCompra.objects.filter(
                compra_id=parent_object
            )
            or []
        )
...
class DadosPagamentoCompra(DadosPagamento):
    def __init__(self):
        ...
        self.get_queryset = (
            lambda self, parent_object: Pagamento.objects.filter(
                compra_id=parent_object
            )
            or []
        )
