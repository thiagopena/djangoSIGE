...
class ProcessadorNotaFiscal(object):
    ...
    def montar_nota(self, nota_obj, versao="3.10"):
        ...
        if nota_obj.emit_saida:
            ...
            nfe.infNFe.emit.xFant.valor = (
                nota_obj.emit_saida.pessoa_jur_info.nome_fantasia
            )
            nfe.infNFe.emit.IE.valor = (
                nota_obj.emit_saida.pessoa_jur_info.inscricao_estadual
            )
            ...
            if nota_obj.emit_saida.endereco_padrao:
                nfe.infNFe.emit.enderEmit.xLgr.valor = (
                    nota_obj.emit_saida.endereco_padrao.logradouro
                )
                nfe.infNFe.emit.enderEmit.nro.valor = (
                    nota_obj.emit_saida.endereco_padrao.numero
                )
                nfe.infNFe.emit.enderEmit.xCpl.valor = (
                    nota_obj.emit_saida.endereco_padrao.complemento
                )
                nfe.infNFe.emit.enderEmit.xBairro.valor = (
                    nota_obj.emit_saida.endereco_padrao.bairro
                )
                nfe.infNFe.emit.enderEmit.cMun.valor = (
                    nota_obj.emit_saida.endereco_padrao.cmun
                )
                nfe.infNFe.ide.cMunFG.valor = nota_obj.emit_saida.endereco_padrao.cmun
                nfe.infNFe.emit.enderEmit.xMun.valor = (
                    nota_obj.emit_saida.endereco_padrao.municipio
                )
                nfe.infNFe.emit.enderEmit.UF.valor = (
                    nota_obj.emit_saida.endereco_padrao.uf
                )
                nfe.infNFe.emit.enderEmit.CEP.valor = (
                    nota_obj.emit_saida.endereco_padrao.cep
                )
                nfe.infNFe.emit.enderEmit.cPais.valor = (
                    nota_obj.emit_saida.endereco_padrao.cpais
                )
                nfe.infNFe.emit.enderEmit.xPais.valor = (
                    nota_obj.emit_saida.endereco_padrao.pais
                )

            if nota_obj.emit_saida.telefone_padrao:
                nfe.infNFe.emit.enderEmit.fone.valor = (
                    nota_obj.emit_saida.telefone_padrao.get_telefone_apenas_digitos()
                )
        ...
        if nota_obj.dest_saida:
            ...
            if nota_obj.dest_saida.endereco_padrao:
                ...
                nfe.infNFe.dest.enderDest.nro.valor = (
                    nota_obj.dest_saida.endereco_padrao.numero
                )
                nfe.infNFe.dest.enderDest.xCpl.valor = (
                    nota_obj.dest_saida.endereco_padrao.complemento
                )
                nfe.infNFe.dest.enderDest.xBairro.valor = (
                    nota_obj.dest_saida.endereco_padrao.bairro
                )
                nfe.infNFe.dest.enderDest.cMun.valor = (
                    nota_obj.dest_saida.endereco_padrao.cmun
                )
                nfe.infNFe.dest.enderDest.xMun.valor = (
                    nota_obj.dest_saida.endereco_padrao.municipio
                )
                nfe.infNFe.dest.enderDest.UF.valor = (
                    nota_obj.dest_saida.endereco_padrao.uf
                )
                nfe.infNFe.dest.enderDest.CEP.valor = (
                    nota_obj.dest_saida.endereco_padrao.cep
                )
                nfe.infNFe.dest.enderDest.cPais.valor = (
                    nota_obj.dest_saida.endereco_padrao.cpais
                )
                nfe.infNFe.dest.enderDest.xPais.valor = (
                    nota_obj.dest_saida.endereco_padrao.pais
                )

            if nota_obj.dest_saida.telefone_padrao:
                nfe.infNFe.dest.enderDest.fone.valor = (
                    nota_obj.dest_saida.telefone_padrao.get_telefone_apenas_digitos()
                )
        ...
        if nota_obj.venda:
            for index, item in enumerate(nota_obj.venda.itens_venda.all(), 1):
                ...
                if item.produto.grupo_fiscal:
                    ...
                    if (
                        icms_dest.p_fcp_dest
                        or icms_dest.p_icms_dest
                        or icms_dest.p_icms_inter
                        or icms_dest.p_icms_inter_part
                    ):
        ...
        if nota_obj.venda.transportadora:
            if nota_obj.venda.transportadora.tipo_pessoa == "PJ":
                nfe.infNFe.transp.transporta.CNPJ.valor = (
                    nota_obj.venda.transportadora.cpf_cnpj_apenas_digitos
                )
                nfe.infNFe.transp.transporta.IE.valor = (
                    nota_obj.venda.transportadora.pessoa_jur_info.inscricao_estadual
                )
            ...
            nfe.infNFe.transp.transporta.xNome.valor = (
                nota_obj.venda.transportadora.nome_razao_social
            )
            nfe.infNFe.transp.transporta.xEnder.valor = (
                nota_obj.venda.transportadora.endereco_padrao.logradouro
            )
            nfe.infNFe.transp.transporta.xMun.valor = (
                nota_obj.venda.transportadora.endereco_padrao.municipio
            )
            nfe.infNFe.transp.transporta.UF.valor = (
                nota_obj.venda.transportadora.endereco_padrao.uf
            )
    ...
    def importar_xml_cliente(self, request):
        ...
        if NotaFiscalSaida.objects.filter(
            n_nf_saida=str(nfe.infNFe.ide.nNF.valor)
        ).count():
            raise ValueError("Nota com esta numeração já existe na base de dados.")
        ...
        nota_saida.status_nfe = "3"  # Em digitação
        ...
        if nfe.infNFe.dest.CNPJ.valor:
            clientes = [
                c
                for c in Cliente.objects.filter(tipo_pessoa="PJ")
                if c.cpf_cnpj_apenas_digitos == nfe.infNFe.dest.CNPJ.valor
            ]
        elif nfe.infNFe.dest.CPF.valor:
            clientes = [
                c
                for c in Cliente.objects.filter(tipo_pessoa="PF")
                if c.cpf_cnpj_apenas_digitos == nfe.infNFe.dest.CPF.valor
            ]
        ...
        if len(clientes):
            ...
            if nfe.infNFe.dest.CNPJ.valor:
                ...
                info_cliente = PessoaJuridica()
                cliente.id_estrangeiro = str(nfe.infNFe.dest.idEstrangeiro.valor)
            ...
            ender_cliente.municipio = str(nfe.infNFe.dest.enderDest.xMun.valor).title()
        ...
        if nfe.infNFe.emit.CNPJ.valor:
            empresas = [
                e
                for e in Empresa.objects.filter(tipo_pessoa="PJ")
                if e.cpf_cnpj_apenas_digitos == nfe.infNFe.emit.CNPJ.valor
            ]
        elif nfe.infNFe.emit.CPF.valor:
            empresas = [
                e
                for e in Empresa.objects.filter(tipo_pessoa="PF")
                if e.cpf_cnpj_apenas_digitos == nfe.infNFe.emit.CPF.valor
            ]
        ...
        if len(empresas):
            ...
            ender_empresa.municipio = str(nfe.infNFe.emit.enderEmit.xMun.valor).title()
        ...
        if (
            nfe.infNFe.transp.transporta.CNPJ.valor
            or nfe.infNFe.transp.transporta.CPF.valor
        ):
            transportadoras = []
            if nfe.infNFe.transp.transporta.CNPJ.valor:
                transportadoras = [
                    t
                    for t in Transportadora.objects.filter(tipo_pessoa="PJ")
                    if t.cpf_cnpj_apenas_digitos
                    == nfe.infNFe.transp.transporta.CNPJ.valor
                ]
            elif nfe.infNFe.transp.transporta.CPF.valor:
                transportadoras = [
                    t
                    for t in Transportadora.objects.filter(tipo_pessoa="PF")
                    if t.cpf_cnpj_apenas_digitos
                    == nfe.infNFe.transp.transporta.CPF.valor
                ]
            ...
            if len(transportadoras):
                ...
                if nfe.infNFe.transp.transporta.CNPJ.valor:
                    ...
                    info_transporta.cnpj = str(nfe.infNFe.transp.transporta.CNPJ.valor)
                    ...
                    info_transporta.cpf = str(nfe.infNFe.transp.transporta.CPF.valor)
        ...
        for det in nfe.infNFe.det:
            ...
            if len(produtos):
                ...
                # Natureza Operacao
                nat_ops = NaturezaOperacao.objects.filter(cfop=str(det.prod.CFOP.valor))
                if len(nat_ops):
                    nat_op = nat_ops[0]
                else:
                ...
                grupo_fiscal.descricao = (
                    "Produto: " + str(det.prod.xProd.valor) + " (Importado por XML)"
                )
                ...
                if det.imposto.ICMSUFDest.xml:
                    grupo_icmsufdest.p_fcp_dest = (
                        det.imposto.ICMSUFDest.pFCPUFDest.valor
                    )
                    grupo_icmsufdest.p_icms_dest = (
                        det.imposto.ICMSUFDest.pICMSUFDest.valor
                    )
                    grupo_icmsufdest.p_icms_inter = (
                        det.imposto.ICMSUFDest.pICMSInter.valor
                    )
                    grupo_icmsufdest.p_icms_inter_part = (
                        det.imposto.ICMSUFDest.pICMSInterPart.valor
                    )
                ...
                # Unidade
                unidades = Unidade.objects.filter(sigla_unidade=det.prod.uCom.valor)
                if len(unidades):
                    unidade = unidades[0]
                else:
                    unidade = Unidade()
    ...
    def importar_xml_fornecedor(self, request):
        ...
        if nfe.infNFe.emit.CNPJ.valor:
            fornecedores = [
                f
                for f in Fornecedor.objects.filter(tipo_pessoa="PJ")
                if f.cpf_cnpj_apenas_digitos == nfe.infNFe.emit.CNPJ.valor
            ]
        elif nfe.infNFe.emit.CPF.valor:
            fornecedores = [
                f
                for f in Fornecedor.objects.filter(tipo_pessoa="PF")
                if f.cpf_cnpj_apenas_digitos == nfe.infNFe.emit.CPF.valor
            ]
        ...
        if len(fornecedores):
            ...
            if nfe.infNFe.emit.CNPJ.valor:
                ...
                info_fornecedor.nome_fantasia = str(nfe.infNFe.emit.xFant.valor)
                info_fornecedor.inscricao_estadual = str(nfe.infNFe.emit.IE.valor)
            elif nfe.infNFe.emit.CPF.valor:
        ...
        if nfe.infNFe.dest.CNPJ.valor:
            empresas = [
                e
                for e in Empresa.objects.filter(tipo_pessoa="PJ")
                if e.cpf_cnpj_apenas_digitos == nfe.infNFe.dest.CNPJ.valor
            ]
            if len(empresas):
                ...
                ender_empresa.cpais = str(nfe.infNFe.dest.enderDest.cPais.valor)
                ...
                tel_empresa.telefone = str(nfe.infNFe.dest.enderDest.fone.valor)
    ...
    def verificar_configuracao(self):
        try:
            ...
            return self.salvar_mensagem(
                message="Emissão de NF-e não configurada.", erro=True
            )

        if not self.conf_nfe.arquivo_certificado_a1:
            return self.salvar_mensagem(
                message="Certificado A1 não encontrado.", erro=True
            )
        ...
        try:
            ...
            return self.salvar_mensagem(
                message="Erro ao tentar ler o certificado, verifique se sua senha está correta.",
                erro=True,
            )
    ...
    def verificar_configuracao_nfe(self, nota_obj):
        try:
            ...
            e.tipo = "0"
            e.descricao = "Emissão de NF-e não configurada."
            e.save()
        ...
        if not self.conf_nfe.arquivo_certificado_a1:
            e = ErrosValidacaoNotaFiscal(nfe=nota_obj)
            e.tipo = "0"
            e.descricao = "Certificado A1 não encontrado."
            e.save()
            return self.salvar_mensagem(message=e.descricao, erro=True)
        ...
        try:
            ...
            e.tipo = "0"
            e.descricao = (
                "Erro ao tentar ler o certificado, verifique se sua senha está correta."
            )
            e.save()
            return self.salvar_mensagem(message=e.descricao, erro=True)
    ...
    def validar_nota(self, nota_obj):
        ...
        if not nota_obj.estado:
            e = ErrosValidacaoNotaFiscal(nfe=nota_obj)
            e.tipo = "0"
            e.descricao = "Estado do emitente não foi preenchido."
            e.save()
            return self.salvar_mensagem(message=e.descricao, erro=True)
        else:
            processo = self.nova_nfe.gerar_xml(
                xml_nfe=nfe.xml,
                cert=self.info_certificado["cert"],
                key=self.info_certificado["key"],
                versao=nota_obj.versao,
        ...
        if (
            ErrosValidacaoNotaFiscal.objects.filter(nfe=nota_obj)
            .filter(tipo="0")
            .count()
        ):
            nota_obj.status_nfe = "3"
            return self.salvar_mensagem(
                message='Erros de validação encontrados. Verifique a tab "Validação" para mais detalhes.',
                erro=True,
            )
        else:
    ...
    def emitir_nota(self, nota_obj):
        ...
        if not nota_obj.estado:
            ...
            try:
                processos = self.nova_nfe.processar_nota(
                    xml_nfe=nfe.xml,
                    cert=self.info_certificado["cert"],
                    key=self.info_certificado["key"],
                    versao=nota_obj.versao,
                ...
                # HTTP 200 - OK
                if processos["lote"].resposta.status in ("200", 200):
                    # Lote processado
                    if processos["lote"].resposta.cStat.valor in ("104", 104):
                        if len(processos["notas"]):
                            proc = processos["notas"][0]

                            # Autorizada
                            if proc.protNFe.infProt.cStat.valor == "100":
                                nota_obj.status_nfe = "1"
                                nota_obj.chave = proc.NFe.chave
                                nota_obj.arquivo_proc = proc.caminho_xml

                                e = RespostaSefazNotaFiscal(nfe=nota_obj)
                                e.tipo = "1"
                                e.codigo = str(proc.protNFe.infProt.cStat.valor)
                                e.descricao = str(proc.protNFe.infProt.xMotivo.valor)
                                e.save()
                                self.salvar_mensagem(message=e.descricao, erro=False)

                            # Denegada
                            elif proc.protNFe.infProt.cStat.valor in (
                                "110",
                                "301",
                                "302",
                                "303",
                            ):
                                nota_obj.status_nfe = "2"
                                nota_obj.chave = proc.NFe.chave
                            ...
                            # ocorre)
                            elif proc.protNFe.infProt.cStat.valor < "200":
                                nota_obj.chave = proc.NFe.chave
                    ...
                    # Lote em processamento
                    elif processos["lote"].resposta.cStat.valor in ("105", 105):
                        nota_obj.status_nfe = "4"
                        nota_obj.save()
                        ...
                        e.save()
                        self.salvar_mensagem(message=e.descricao, erro=False)
                    elif processos["lote"].resposta.cStat.valor in ("100", 100):
                        nota_obj.status_nfe = "1"
                        nota_obj.save()
                        ...
                        e = RespostaSefazNotaFiscal(nfe=nota_obj)
                        e.tipo = "0"
                        e.descricao = "Erro ao processar lote, motivo: " + str(
                            processos["lote"].resposta.xMotivo.valor
                        )
                        e.codigo = str(processos["lote"].resposta.cStat.valor)
                        e.save()
                        self.salvar_mensagem(message=e.descricao, erro=True)
                ...
                elif processos["lote"].resposta.status in ("403", 403):
                    e = RespostaSefazNotaFiscal(nfe=nota_obj)
                    e.tipo = "0"
                    e.descricao = (
    ...
    def cancelar_nota(self, nota_obj):
        ...
        if not nota_obj.estado:
            ...
            try:
                processo = self.nova_nfe.cancelar_nota(
                    chave=nota_obj.chave,
                    protocolo=nota_obj.numero_protocolo,
                    justificativa=nota_obj.just_canc,
                    cert=self.info_certificado["cert"],
                    key=self.info_certificado["key"],
                    versao=nota_obj.versao,
                    ambiente=int(nota_obj.tp_amb),
                ...
                # HTTP 200 - OK
                if processo.resposta.status in ("200", 200):
                    if len(processo.resposta.retEvento):
                        ...
                        # vinculado a NF-e
                        if (
                            ret.infEvento.cStat.valor == "101"
                            or ret.infEvento.cStat.valor == "135"
                        ):
                            nota_obj.status_nfe = "8"
                        ...
                        elif ret.infEvento.cStat.valor < "200":
                            e = RespostaSefazNotaFiscal(nfe=nota_obj)
                            e.tipo = "1"
                            e.codigo = str(ret.infEvento.cStat.valor)
                            e.descricao = str(ret.infEvento.xMotivo.valor)
                ...
                # HTTP 403 - Acesso proibido
                elif processo.resposta.status in ("403", 403):
                    e = RespostaSefazNotaFiscal(nfe=nota_obj)
                    e.tipo = "0"
                    e.descricao = (
                        "Erro de autenticação, verifique se seu certificado é válido."
    ...
    def gerar_danfe(self, nota_obj):
        ...
        if not nota_obj.caminho_proc_completo:
            return self.salvar_mensagem(
                message="Arquivo de processamento da nota não encontrado. Verifique se sua nota foi processada corretamente.",
                erro=True,
            )
        ...
        danfe = self.nova_nfe.gerar_danfe(
            proc_nfe,
            nome_sistema="PySIGNFe",
            leiaute_logo_vertical=self.conf_nfe.leiaute_logo_vertical,
            versao=nota_obj.versao,
            logo=logo_path,
        )
    ...
    def gerar_danfce(self, nota_obj):
        ...
        if not self.conf_nfe.csc or not self.conf_nfe.cidtoken:
            return self.salvar_mensagem(
                message="Insira o Código de Segurança do Contribuinte e o Identificador do CSC na área de configuração de NF-e.",
                erro=True,
            )

        danfce = self.nova_nfe.gerar_danfe(
            proc_nfe,
            csc=self.conf_nfe.csc,
            cidtoken=self.conf_nfe.cidtoken,
            versao=nota_obj.versao,
        )
    ...
    def consultar_cadastro(self, empresa, salvar_arquivos):
        ...
        if not empresa.uf_padrao:
            return self.salvar_mensagem(
                message="Estado do emitente não foi preenchido.", erro=True
            )
        elif not empresa.cpf_cnpj_apenas_digitos:
            return self.salvar_mensagem(
                message="CNPJ do emitente não foi preenchido.", erro=True
            )
        else:
            try:
                processo = self.nova_nfe.consultar_cadastro(
                    cert=self.info_certificado["cert"],
                    key=self.info_certificado["key"],
                    cpf_cnpj=empresa.cpf_cnpj_apenas_digitos,
                    versao="3.10",
                    ambiente=2,
                ...
                if processo.resposta.status in ("200", 200):
                    if (
                        processo.resposta.infCons.cStat.valor
                        and processo.resposta.infCons.cStat.valor < "200"
                    ):
                        return self.salvar_mensagem(
                            message=str(processo.resposta.infCons.xMotivo.valor),
                            erro=False,
                        )
                    else:
                        return self.salvar_mensagem(
                    ...
                    return self.salvar_mensagem(
                        message="Erro ao consultar cadastro, verifique a versão do seu aplicativo e a validade do seu certificado.",
                        erro=True,
                    )

            except SSLError as e:
                return self.salvar_mensagem(
                    message="Erro de autenticação: {}".format(e), erro=True
                )
    ...
    def inutilizar_notas(
        ...
        if not empresa.uf_padrao:
            ...
            processo = self.nova_nfe.inutilizar_faixa_numeracao(
            ...
            if processo.resposta.status in ("200", 200):
                if (
                    ...
                    and processo.resposta.infInut.cStat.valor < "200"
                ):
                    return self.salvar_mensagem(
                        message=str(processo.resposta.infInut.xMotivo.valor), erro=False
                    )
                else:
                    return self.salvar_mensagem(
                        message=str(processo.resposta.infInut.xMotivo.valor), erro=True
                    )
            else:
                return self.salvar_mensagem(
                    message="Erro ao inutilizar notas, verifique a versão do seu aplicativo e a validade do seu certificado.",
                    erro=True,
                )
    ...
    def consultar_nota(self, chave, ambiente, salvar_arquivos):
        ...
        try:
            ...
            return self.salvar_mensagem(
                message="Chave com código da UF incorreto.", erro=True
            )

        processo = self.nova_nfe.consultar_nfe(
            chave=chave,
            cert=self.info_certificado["cert"],
            key=self.info_certificado["key"],
            versao="3.10",
        ...
        if processo.resposta.status in ("200", 200):
            if processo.resposta.cStat.valor and processo.resposta.cStat.valor < "200":
                return self.salvar_mensagem(
                    message=str(processo.resposta.xMotivo.valor), erro=False
                )
            else:
                return self.salvar_mensagem(
                    message=str(processo.resposta.xMotivo.valor), erro=True
                )
        else:
            return self.salvar_mensagem(
                message="Erro ao consultar nota, verifique a versão do seu aplicativo e a validade do seu certificado.",
                erro=True,
            )
    ...
    def baixar_nota(self, chave, ambiente, ambiente_nacional, salvar_arquivos):
        ...
        processo = self.nova_nfe.download_notas(
            cnpj=cnpj,
            lista_chaves=[
                chave,
            ],
            ambiente_nacional=ambiente_nacional,
            cert=self.info_certificado["cert"],
            key=self.info_certificado["key"],
            versao="3.10",
            ambiente=int(ambiente),
        ...
        if processo.resposta.status in ("200", 200):
            ...
            return self.salvar_mensagem(
                message="Erro ao baixar nota, verifique a versão do seu aplicativo e a validade do seu certificado.",
                erro=True,
            )
    ...
    def efetuar_manifesto(
        ...
        processo = self.nova_nfe.efetuar_manifesto(
            cnpj=cnpj,
        ...
        if processo.resposta.status in ("200", 200):
            ...
            return self.salvar_mensagem(
                message="Erro ao efetuar manifesto, verifique a versão do seu aplicativo e a validade do seu certificado.",
                erro=True,
            )
