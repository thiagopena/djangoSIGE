...
from djangosige.cadastro.models import Cliente, Fornecedor, Produto, Empresa, Transportadora
...
from djangosige.financeiro.models import MovimentoCaixa, Entrada, Saida
