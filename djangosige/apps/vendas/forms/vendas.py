...
class VendaForm(forms.ModelForm):
    ...
    total_sem_imposto = forms.DecimalField(widget=forms.TextInput(attrs={'class':'form-control decimal-mask', 'readonly':True}), label='Total s/ imposto (R$)', required=False)
...
class OrcamentoVendaForm(VendaForm):
    class Meta(VendaForm.Meta):
        ...
        widgets['data_vencimento'] = forms.DateInput(attrs={'class':'form-control datepicker'})
...
class PedidoVendaForm(VendaForm):
    class Meta(VendaForm.Meta):
        model = PedidoVenda
        fields = VendaForm.Meta.fields + ('data_entrega', 'status', 'orcamento',)
        widgets = VendaForm.Meta.widgets
        widgets['data_entrega'] = forms.DateInput(attrs={'class':'form-control datepicker'})
        widgets['status'] = forms.Select(attrs={'class':'form-control', 'disabled':True})
        widgets['orcamento'] = forms.Select(attrs={'class':'form-control', 'disabled':True})
        labels = VendaForm.Meta.labels
...
class ItensVendaForm(forms.ModelForm):
    ...
    total_sem_desconto = forms.DecimalField(widget=forms.TextInput(attrs={'class':'form-control decimal-mask', 'readonly':True}), label='Subtotal s/ desconto', required=False)
    ...
    total_impostos     = forms.DecimalField(widget=forms.TextInput(attrs={'class':'form-control decimal-mask', 'readonly':True}), label='Impostos', required=False)
    ...
    total_com_impostos = forms.DecimalField(widget=forms.TextInput(attrs={'class':'form-control decimal-mask', 'readonly':True}), label='Total', required=False)
    calculo_imposto    = forms.CharField(widget=forms.TextInput(attrs={'class':'hidden', 'disabled':True}), label='Cálc. Impostos', required=False)
    
    ##IMPOSTO
    p_red_bc     = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    p_red_bcst   = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    p_mvast      = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    pfcp         = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    p_icms_dest  = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    p_icms_inter = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    p_icms_part  = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
    tipo_ipi     = forms.ChoiceField(widget=forms.Select(attrs={'class':'modal-field', 'disabled':True}), choices = ([('1','1'), ('2','2'),('3','3'),]), required=False)
    vfixo_ipi    = forms.DecimalField(widget=forms.TextInput(attrs={'class':'modal-field', 'disabled':True}), required=False)
...
ItensVendaFormSet = inlineformset_factory(Venda, ItensVenda, form=ItensVendaForm, extra=1, can_delete=True)