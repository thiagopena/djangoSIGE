...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='venda',
            name='cond_pagamento',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='venda_pagamento', to='vendas.CondicaoPagamento'),
        ),
        migrations.AddField(
            model_name='venda',
            name='local_orig',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='venda_local_estoque', to='estoque.LocalEstoque'),
        ),
        migrations.AddField(
            model_name='venda',
            name='transportadora',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='venda_transportadora', to='cadastro.Transportadora'),
        ),
        migrations.AddField(
            model_name='venda',
            name='veiculo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='venda_veiculo', to='cadastro.Veiculo'),
        ),
        migrations.AddField(
            model_name='pagamento',
            name='venda_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parcela_pagamento', to='vendas.Venda'),
        ),
        migrations.AddField(
