...
urlpatterns = [
    ...
    url(r'orcamentocompra/adicionar/$', views.AdicionarOrcamentoCompraView.as_view(), name='addorcamentocompraview'),
    #/compras/orcamentocompra/listaorcamentocompra
    url(r'orcamentocompra/listaorcamentocompra/$', views.OrcamentoCompraListView.as_view(), name='listaorcamentocompraview'),
    #/compras/orcamentocompra/editar/
    url(r'orcamentocompra/editar/(?P<pk>[0-9]+)/$', views.EditarOrcamentoCompraView.as_view(), name='editarorcamentocompraview'),
    ...
    url(r'pedidocompra/listapedidocompra/$', views.PedidoCompraListView.as_view(), name='listapedidocompraview'),
    #/compras/pedidocompra/editar/
    url(r'pedidocompra/editar/(?P<pk>[0-9]+)/$', views.EditarPedidoCompraView.as_view(), name='editarpedidocompraview'),
    ...
    #Gerar pdf pedido
    url(r'gerarpdfpedidocompra/(?P<pk>[0-9]+)/$', views.GerarPDFPedidoCompra.as_view(), name='gerarpdfpedidocompra'),
    #Gerar pedido a partir de um orçamento
    url(r'gerarpedidocompra/(?P<pk>[0-9]+)/$', views.GerarPedidoCompraView.as_view(), name='gerarpedidocompra'),
    #Copiar orcamento/pedido cancelado ou realizado
    url(r'copiarcompra/(?P<pk>[0-9]+)/$', views.GerarCopiaCompraView.as_view(), name='copiarcompra'),
    #Cancelar Pedido/Orcamento de compra
    url(r'cancelarcompra/(?P<pk>[0-9]+)/$', views.CancelarCompraView.as_view(), name='cancelarcompra'),
    #Receber Pedido de compra
    url(r'recebercompra/(?P<pk>[0-9]+)/$', views.ReceberCompraView.as_view(), name='recebercompra'),
]