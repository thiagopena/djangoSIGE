...
class ProdutoEstocado(models.Model):
    local       = models.ForeignKey('estoque.LocalEstoque', related_name="local_produto_estocado", on_delete=models.CASCADE, null=True, blank=True)
    produto     = models.ForeignKey('cadastro.Produto', related_name="produto_estocado", on_delete=models.CASCADE, null=True, blank=True)
