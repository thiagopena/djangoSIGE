...
urlpatterns = [
	...
	url(r'notafiscal/saida/listanotafiscal/$', views.NotaFiscalSaidaListView.as_view(), name='listanotafiscalsaidaview'),
	#/fiscal/notafiscal/saida/editar/
	url(r'notafiscal/saida/editar/(?P<pk>[0-9]+)/$', views.EditarNotaFiscalSaidaView.as_view(), name='editarnotafiscalsaidaview'),
	...
	url(r'notafiscal/emitir/(?P<pk>[0-9]+)/$', views.EmitirNotaView.as_view(), name='emitirnotafiscal'),
    #Clonar nota
    url(r'notafiscal/copiar/(?P<pk>[0-9]+)/$', views.GerarCopiaNotaView.as_view(), name='copiarnotafiscal'),
    #Cancelar nota
    url(r'notafiscal/cancelar/(?P<pk>[0-9]+)/$', views.CancelarNotaView.as_view(), name='cancelarnotafiscal'),
    #Gerar DANFE
    ...
    #Inutilizar notas
    url(r'notafiscal/inutilizarnotas/$', views.InutilizarNotasView.as_view(), name='inutilizarnotas'),
    #Consultar nota
    url(r'notafiscal/consultarnota/$', views.ConsultarNotaView.as_view(), name='consultarnota'),
    url(r'^notafiscal/consultarnota/(?P<pk>[0-9]+)/$', views.ConsultarNotaView.as_view(), name='consultarnota'),
    #Baixar nota
    url(r'notafiscal/baixarnota/$', views.BaixarNotaView.as_view(), name='baixarnota'),
    url(r'^notafiscal/baixarnota/(?P<pk>[0-9]+)/$', views.BaixarNotaView.as_view(), name='baixarnota'),
    #Manifestacao destinatario
    url(r'notafiscal/manifestacaodestinatario/$', views.ManifestacaoDestinatarioView.as_view(), name='manifestacaodestinatario'),
]