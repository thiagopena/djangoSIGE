    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cadastro.Categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('pessoa_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cadastro.Pessoa')),
                ('logo_file', models.ImageField(blank=True, default='imagens/logo.png', null=True, upload_to=djangosige.apps.cadastro.models.empresa.logo_directory_path)),
