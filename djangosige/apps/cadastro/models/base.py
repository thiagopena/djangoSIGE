...
class PessoaJuridica(models.Model):
    ...
    def format_ie(self):
        if self.inscricao_estadual:
            return f"IE: {self.inscricao_estadual}"
        else:
            return ""
    ...
    def format_responsavel(self):
        if self.responsavel:
            return f"Representante: {self.responsavel}"
        else:
            return ""
...
class Endereco(models.Model):
    ...
    def format_endereco_completo(self):
        return f"{self.logradouro} - {self.numero} - {self.bairro} - {self.municipio} - {self.cep} - {self.uf} - {self.pais}"
...
class Banco(models.Model):
    ...
    def __unicode__(self):
        s = f"{self.get_banco_display()} / {self.agencia} / {self.conta}"
        return s
