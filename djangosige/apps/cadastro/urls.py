...
urlpatterns = [
	...
	url(r'produto/listaprodutos/$', views.ProdutosListView.as_view(), name='listaprodutosview'),
	...
	url(r'outros/adicionarcategoria/$', views.AdicionarCategoriaView.as_view(), name='addcategoriaview'),
